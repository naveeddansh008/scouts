                    ...
                    'items'=>[
                        ...
                        // ],
                          [
                            ...
                            'url' => ['/intitilize/regions/index']
                         ],
                          [
                            'label'=>Yii::t('backend', 'data view'),
                            'url' => '#',
                            'icon'=>'<i class="fa fa-edit"></i>',
                            'options'=>['class'=>'treeview'],
                            'items'=>[
                                ['label'=>Yii::t('backend', 'Town'), 'url'=>['/intitilize/town/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Jamat khana'), 'url'=>['/intitilize/jamat-khana/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Categories'), 'url'=>['/intitilize/category/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Scouts Information'), 'url'=>['/intitilize/registration/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                            
                            ]
                        ],
                      
                          [
                            'label' => 'Scouts Registration Form',
                            'icon' => '<i class="fa fa-pencil"></i>',
                            'url' => ['/intitilize/registration/create']
                         ],
